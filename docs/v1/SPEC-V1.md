> **Document historique — spécification fondatrice de la v1.**
> Restauré au dépôt le 2026-08-17 (décision D-R0-4, [COMITES.md](../COMITES.md)) : il avait été
> retiré du dépôt en juillet 2026 et n'existait plus que dans l'historique git.
> Le code source y fait référence partout sous la forme « §6.4 », « §SPEC » : il reste
> la référence pour comprendre l'existant. Pour la suite du projet, voir [specs/](../specs/).
