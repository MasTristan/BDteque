> **Document historique — mémo d'implémentation de la v1.**
> Restauré au dépôt le 2026-08-17 (décision D-R0-4, [COMITES.md](../COMITES.md)).
> Décrit l'état du projet à la fin de la v1 et ses conventions de code, dont plusieurs
> ont été confirmées ou amendées en v2 — voir [DECISIONS.md](../DECISIONS.md).
